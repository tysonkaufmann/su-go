...
it('Delete Routes - Successful', async done => {
  ...
  const response3 = await request.post('/api/routes/' + route.routeid + '/delete').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('View Traffic - Successful', async done => {
  ...
  const response5 = await request.get('/api/routes/' + route.routeid + '/traffic')
...
it('End Routes - Successful', async done => {
  ...
  const response4 = await request.post('/api/routes/' + route.routeid + '/endroute').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('Start Routes - User Already on Route', async done => {
  ...
  const response4 = await request.post('/api/routes/' + route.routeid + '/startroute').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('View Traffic - Route Not Found', async done => {
  ...
  const response3 = await request.get('/api/routes/fakefakefake/traffic')
...
it('Start Routes - Route Not Found', async done => {
  ...
  const response3 = await request.post('/api/routes/fakefakefake/startroute').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('End Routes - Route Not Found', async done => {
  ...
  const response3 = await request.post('/api/routes/fakefakefake/endroute').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('Delete Routes - Route Not Found', async done => {
  ...
  const response3 = await request.post('/api/routes/fakefakefake/delete').set('x-auth-username', 'aryastark').set('x-auth-token', token).send(payload2)
...
it('Start Routes - Conflicting Usernames', async done => {
  ...
  const payload2 = { username: 'fakefakefake' }
...
afterAll(async () => {
  jest.setTimeout(30000)
  let newUserInfo = await User.deleteOne({ username: 'Cheng' })
