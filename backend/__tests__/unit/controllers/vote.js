...
test('Vote a Route - Route Not Found', () => {
  ...
  const payload = { username: 'aryastark', score: 2 }
...
test('Vote a Route - Score Not in Range', () => {
  ...
  const payload = { username: 'aryastark', score: 10 }
...
test('Vote a Route - Username Mismatch', () => {
  ...
  const payload = { username: 'Mitul23', score: 3 }
...
test('Vote a Route - Vote adding Successful', () => {
  ...
  const payload = { username: 'Mitul2', score: 2 }
...
test('Vote a Route - Vote updating Successful', () => {
  ...
  const payload = { username: 'Mitul2', score: 3 }
